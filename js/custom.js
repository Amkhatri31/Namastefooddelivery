...
(function($) {
    "use strict";
		...
		// 	jQuery('#changeable-colors').attr('href', 'css/colors/' + 'moderate-green' + '.css');
		// 	return false;
		// });
		...
		// 	jQuery(".logo-header img").attr("src", "images1/logo2.png");
		// 	jQuery(".footer-logo .text-center img").attr("src", "images1/logo2.png");
		// 	return false;
		// });
